    ...
    <div class="card">
      ...
      <div class="card-body login-card-body">
        ...
        <div class="login-logo">
          <center>
            <img src="company/bjmp_logo.png" width="150" height="130" class="user-image" alt="User Image" />
          </center>
        </div>
        <p class="login-box-msg"><strong style="color: blue">FORGOT PASSWORD</strong></p>
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            <input type="text" name="phone" class="form-control" placeholder="OTP" required>
            <div class="input-group-append">
              <div class="input-group-text">
