...
if ($count > 0) {
    // Student with the same name already exists, show error message
    ...
    try {
        ...
        $parent_id = $dbh->lastInsertId(); // Get last inserted parent ID
        ...
        if (isset($class_id)) {
            ...
            $remarks = "none"; // Set default remarks

            // Insert class enrollment record
